export const TLA_TO_A2: Record<string, string> = {
  ...
  EGY: "EG", ENG: "GB-ENG", ESP: "ES", ETH: "ET", FIN: "FI", FRA: "FR",
  GAB: "GA", GEO: "GE", GER: "DE", GHA: "GH", GNB: "GW", GRE: "GR",
  GTM: "GT", GUI: "GN", HAI: "HT", HON: "HN", HUN: "HU", IDN: "ID", IND: "IN",
  IRL: "IE", IRN: "IR", IRQ: "IQ", ISL: "IS", ISR: "IL", ITA: "IT",
  IVC: "CI", JAM: "JM", JAP: "JP", JPN: "JP", JOR: "JO", KAZ: "KZ", KEN: "KE",
  ...
  SCO: "GB-SCT", SEN: "SN", SLE: "SL", SLO: "SI", SLV: "SV", SOM: "SO",
  SRB: "RS", SSD: "SS", SUI: "CH", SUR: "SR", SVK: "SK", SVN: "SI",
  SWE: "SE", SYR: "SY", TAN: "TZ", THA: "TH", TRI: "TT", TUN: "TN",
  TUR: "TR", UAE: "AE", UGA: "UG", UKR: "UA", URU: "UY", URY: "UY", USA: "US",
  UZB: "UZ", VEN: "VE", VIE: "VN", WAL: "GB-WLS", YEM: "YE", ZAM: "ZM",
  ZIM: "ZW",
